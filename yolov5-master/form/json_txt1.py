...
classes = ["HC", "PD"]
# 1.标签路径
# labelme_path = r"D:/mydata/labels/"
labelme_path = r"D:/NingXia/YOLO/image_json_1/"
...
def ChangeToYolo5(files, txt_Name):
    if not os.path.exists('tmp/data_1/'):
        os.makedirs('tmp/data_1/')
    list_file = open('tmp/data_1/%s.txt' % (txt_Name), 'w')
